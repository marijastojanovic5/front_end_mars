    ...
    return (
       <div className="pic container-fluid about-page">
            ...
            <p> Mars is the fourth planet from the Sun and orbits the Sun
               ...
               surface of Mars. Mars completes one orbital revolution around
               the Sun every 1.88 Earth years. Two small natural satellites,
                Demos and Phobos, orbit
        ...
        <button className="btn btn-primary" data-target="#aboutModal" data-toggle="modal" id="login-btn"> More about Mars
        </button>
       <div className="modal fade"  tabIndex="-1" id="aboutModal" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true" 
        ...
        <div className="modal-dialog modal-dialog-centered modal-lg" role="document">
            ...
            <div className="modal-header">
                <h5 className="modal-title" >More about Mars</h5>
