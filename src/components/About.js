...
<button className="btn btn-primary" data-target="#aboutModal" data-toggle="modal"> Read More
</button>
  ...
  <div className="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div className="modal-content">
      ...
      (225 million km). Mars rotates on its axis, completing one
                ...
                natural satellites, Demos and Phobos, 
      </div>
    </div>
  </div>
</div>
...
//                from radiation from the Sun.</p>

//            <p> Many of the features on the surface of Mars resemble features 
